...
class KSResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        ks_res.update(
            ...
            ks_sales_discount_account=int(self.env['ir.config_parameter'].get_param('ks_sales_discount_account')),
            ks_purchase_discount_account=int(self.env['ir.config_parameter'].get_param('ks_purchase_discount_account')),
